...
GO
PRINT N'Dropping Index [dbo].[Customer].[IX_Customer_TypeId]...';


GO
DROP INDEX [IX_Customer_TypeId]
    ON [dbo].[Customer];


GO
PRINT N'Dropping Index [dbo].[Customer].[IX_Customer_Email]...';
...
GO
ALTER TABLE [dbo].[Customer] ALTER COLUMN [Title] CHAR (10) NULL;
